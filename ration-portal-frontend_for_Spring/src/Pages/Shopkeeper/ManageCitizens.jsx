...
const ManageCitizens = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const shopkeeperId = getUserId();
            const fullAddress = formData.address + ", " + formData.city + ", Maharashtra";
        ...
        <div className="animate-in fade-in duration-500">
            ...
            {showForm && (
                <div className=" rounded-xl border-2  p-8 mb-8 shadow-sm">
                    <h4 className="text-xl font-bold text-[#003D82] mb-6 uppercase tracking-tight">New Citizen Enrollment</h4>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 border-2 border-gray-100 rounded-xl focus:border-[#FF6B35] focus:outline-none transition-all"
